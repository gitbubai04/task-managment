...
import { changeStatusController, createTaskController, deleteTaskController, getAllTaskController, getTaskByIdController, updateTaskController } from '../controllers/task.controller';
import { authMiddleware } from '../middleware/auth.middleware';

const taskRouter = express.Router();

taskRouter.post('/add', authMiddleware, createTaskController);
taskRouter.get('/all', authMiddleware, getAllTaskController);
