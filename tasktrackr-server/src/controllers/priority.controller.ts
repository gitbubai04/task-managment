...
export const createPriorityController = async (req: Request, res: Response) => {
  try {
...
export const updatePriorityController = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { userId: user_id } = res.locals;
    const { name, color } = req.body;
...
export const deletePriorityController = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { userId: user_id } = res.locals;
